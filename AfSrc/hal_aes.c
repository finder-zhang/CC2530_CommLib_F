/**************************************************************************************************
  Filename:       hal_aes.c
  Revised:        $Date: 2009-03-26 15:50:07 -0700 (Thu, 26 Mar 2009) $
 ...
 * @fn      AesLoadIV
 *
 * @brief   Writes IV into the CC2530
 *
 * input parameters
 *
 ...
 * @fn      AesLoadKey
 *
 * @brief   Writes the key into the CC2530
 *
 * input parameters
 *
 ...
 * @fn      AesDmaSetup
 *
 * @brief   Sets up DMA of 16 byte block using CC2530 HW aes encryption engine
 *
 * input parameters
 *
